...
# installed.
TCL_PREFIX='E:/git_demo/app\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/git_demo/app\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/git_demo/app\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/git_demo/app\Library\include'
...
TCL_PACKAGE_PATH='E:/git_demo/app\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/git_demo/app\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/git_demo/app\Library\lib\tclstub86.lib'
